#' Regression Calibration (Internal) for Linear Models via a Formula Interface
#'
#' @description
...
#' @param link Character string specifying the link function for the linear model
#'   (default = "linear").
