#' Sandwich Variance Estimator for Internal Poisson Regression
#'
#' Computes robust (sandwich) variance-corrected coefficient estimates for
#' Poisson regression models when replicate exposure measurements are
...
#' @param Y Outcome count vector for the main-study subjects.
...
#'
#' @details
#' This function applies the sandwich variance estimator for Poisson regression models with
